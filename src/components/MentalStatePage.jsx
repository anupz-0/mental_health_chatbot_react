...
const MentalStatePage = ({ onBack, onHomeClick, onMentalStateClick, onHistoryClick, onFAQsClick }) => {
  ...
  useEffect(() => {
    ...
    // Listen for storage changes (when VoicePage saves new analysis)
    ...
    // Also poll every 2 seconds to catch same-window updates
  ...
  const loadAnalysisData = () => {
    ...
    if (latest) {
      setLatestAnalysis(JSON.parse(latest));
    }
    ...
    return (
      <div className="flex h-screen bg-[#0a0515] text-white overflow-hidden">
        ...
        <div className="flex flex-col flex-1 items-center justify-center bg-gradient-to-br from-[#0a0515] via-[#140a2e] to-[#0a0515]">
          ...
          <p className="text-purple-300/60 mb-6">Use the Voice Assistant to share your thoughts first.</p>
          <button 
            onClick={onBack}
          ...
          <div className="max-w-6xl mx-auto space-y-6">
            ...
            <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="pt-4 border-t border-purple-500/20">
                    <p className="text-sm text-purple-300/70">
                      Confidence Level: <span className="font-semibold text-purple-300">{latestAnalysis.emotion.confidence >= 70 ? 'High' : latestAnalysis.emotion.confidence >= 50 ? 'Moderate' : 'Low'}</span>
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-[#1a1035]/60 backdrop-blur-md border border-purple-500/30 rounded-2xl p-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="pt-4 border-t border-purple-500/20">
                    <p className="text-sm text-purple-300/70">
                      Confidence Level: <span className="font-semibold text-purple-300">{latestAnalysis.mentalHealth.confidence >= 70 ? 'High' : latestAnalysis.mentalHealth.confidence >= 50 ? 'Moderate' : 'Low'}</span>
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-gradient-to-r from-purple-600/20 to-pink-600/20 backdrop-blur-md border border-purple-500/30 rounded-2xl p-6">
              ...
              <p className="text-purple-200 leading-relaxed">
                ...
                If you're experiencing severe emotional distress, please reach out to a mental health professional or 
                crisis hotline.
              </p>
            </div>
